function [mutant_identity, neut_mutant_identity] = parse_neutral_mutations_for_neutral_effects_last5sites(seq1, seq2)
...
for i = 1:size_lib_seq2
    ...
    if i == 1               %% CHANGE THIS DEPENDING ON WHICH SITE YOU WANT TO TEST EFFECT OF NEUTRAL MUTATION, 1 is site 6.. 5 is site 10
        if nt == seq2_lib_WT(i)  
