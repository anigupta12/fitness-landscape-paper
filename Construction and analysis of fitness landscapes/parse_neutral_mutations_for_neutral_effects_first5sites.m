function [mutant_identity, neut_mutant_identity] = parse_neutral_mutations_for_neutral_effects_first5sites(seq1, seq2)
...
for i = 1:size_lib_seq1
    ...
    if i == 5                   %% CHANGE THIS DEPENDING ON WHICH SITE YOU WANT TO TEST EFFECT OF NEUTRAL MUTATION
        if nt == seq1_lib_WT(i)
